...
import { registerCustomEase } from '../utils/animation.ts';
import { Logo } from '../ui/Logo.ts';
import { Dragon } from '../ui/Dragon.ts';
import { waitFor } from '../utils/asyncUtils';
import { SmallButton } from '../ui/SmallButton.ts';
import { ImageButton } from '../ui/ImageButton.ts';
import { RippleButton } from '../ui/RippleButton.ts';
...
export class HomeScreen extends Container {
  ...
  public async show() {
    ...
    //? */ Reset visual state, hide things that will show up later => hide all items below without animation
    ...
    //* when the home screen open => show the dragon and logo without animation
