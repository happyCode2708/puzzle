...
import { GameMatch3Board } from './GameMatch3Board';
 ...
 */
export class PuzzlingBoard extends Container {
  ...
  constructor(game: GameScreen) {
    ...
    this.board = new GameMatch3Board(this);
  ...
  public stopInteractChildren() {
    this.interactiveChildren = false;
  }

  public continueInteractChildren() {
    this.interactiveChildren = true;
  }
}
