...
export class Match3Process {
  ...
  public async stop() {
    ...
    console.log(
      '[Match3] Grid:\n' + match3GridToString(this.match3.board.pieceGrid)
    );
  ...
  private async updateStats() {
    const matches = match3GetMatches(this.match3.board.pieceGrid);
  ...
  private async processCheckpoint() {
    ...
    const emptySpaces = match3GetEmptyPositions(this.match3.board.pieceGrid);
